...
draw_sprite_stretched(ms, 0,  camera_get_view_x(view_camera[view_current]), camera_get_view_y(view_camera[view_current]) + hs_height * 1.25, ms_width, ms_height);
draw_set_font(font_money);
draw_text_ext(camera_get_view_x(view_camera[view_current]) + 1.2 * ms_width, camera_get_view_y(view_camera[view_current]) + hs_height * 1.25, global.money, 0.1 * ms_width, 1.9 * ms_width);